    ...
    rules: {
        ...
        import_clause: ($) =>
            choice(
                ...
                seq(
                    $.identifier,
                    optional(
                        seq(",", choice($.namespace_import, $.named_imports)),
                    ),
                ),
            ),
        ...
        for_statement: ($) =>
            seq(
                ...
                field(
                    "condition",
                    choice(seq($._expressions, ";"), $.empty_statement),
                ),
        ...
        _for_header: ($) =>
            seq(
                ...
                choice(
                    field(
                        "left",
                        choice($._lhs_expression, $.parenthesized_expression),
                    ),
                    seq(
                        field("kind", "var"),
                        field(
        ...
        jsx_namespace_name: ($) =>
            seq($._jsx_identifier, ":", $._jsx_identifier),
        ...
        jsx_attribute: ($) =>
            seq(
                $._jsx_attribute_name,
                optional(seq("=", $._jsx_attribute_value)),
            ),
            ...
            choice(
                ...
                prec(
                    ...
                    seq(
                        field(
                            "function",
                            choice($.primary_expression, $.new_expression),
                        ),
        ...
        member_expression: ($) =>
            prec(
                ...
                seq(
                    field(
                        "object",
                        choice($.expression, $.primary_expression, $.import),
                    ),
        ...
        // not patterns.
        pattern: ($) =>
            prec.dynamic(-1, choice($._lhs_expression, $.rest_pattern)),
