...
enum ts_symbol_identifiers {
  ...
  sym_program_name = 17,
  sym_section = 18,
  sym_define_device_section = 19,
  sym_device_definition = 20,
  sym_device_dps = 21,
  sym_string_literal = 22,
  aux_sym_define_device_section_repeat1 = 23,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 670, lookahead)) ADVANCE(57);
      END_STATE();
    case 1:
      if (lookahead == '\n') SKIP(7);
      END_STATE();
    ...
    case 57:
      ...
      if (set_contains(sym_identifier_character_set_2, 778, lookahead)) ADVANCE(57);
      END_STATE();
    case 58:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_define_device_section, 1, 0, 0),
  [13] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [15] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_define_device_section, 2, 0, 0),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_define_device_section_repeat1, 2, 0, 0),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_define_device_section_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_device_dps, 5, 0, 0),
  [24] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [26] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program_name, 3, 0, 0),
  [30] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_device_definition, 3, 0, 0),
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3, 0, 0),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_device_dps, 6, 0, 0),
  ...
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 1, 0, 0),
