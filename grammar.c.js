    ...
    rules: {
        ...
        parenthesized_declarator: ($) =>
            prec.dynamic(
                ...
                seq("(", optional($.ms_call_modifier), $._declarator, ")"),
            ),
        parenthesized_field_declarator: ($) =>
            prec.dynamic(
                PREC.PAREN_DECLARATOR,
        ...
        parenthesized_type_declarator: ($) =>
            prec.dynamic(
                PREC.PAREN_DECLARATOR,
                seq("(", optional($.ms_call_modifier), $._type_declarator, ")"),
            ),
        abstract_parenthesized_declarator: ($) =>
            prec(
                1,
        ...
        seh_finally_clause: ($) =>
            seq("__finally", field("body", $.compound_statement)),

        seh_leave_statement: (_) => seq("__leave", ";"),
        ...
        _string: ($) =>
            prec.left(choice($.string_literal, $.concatenated_string)),
        ...
        gnu_asm_clobber_list: ($) =>
            seq(":", commaSep(field("register", $._string))),

        gnu_asm_goto_list: ($) =>
            seq(":", commaSep(field("label", $.identifier))),
